...
TRANSLATIONS: Dict[str, Dict[str, str]] = {
    "es": {
        ...
        "status.gamepad_error_tooltip": "Error en gamepad virtual. Verifica ViGEmBus (Windows) o permisos en /dev/uinput (Linux).",
    ...
    "en": {
        ...
        "status.gamepad_error_tooltip": "Virtual gamepad error. Check ViGEmBus (Windows) or /dev/uinput permissions (Linux).",
