...
TRANSLATIONS: Dict[str, Dict[str, str]] = {
    "es": {
        ...
        "mapping.invert_clutch": "Invertir Eje de Embrague",
        ...
        "mapping.assigned_buttons": "Botones Xbox",
        ...
        "calib.axis_clutch": "Pedal de Embrague",
        ...
        "calib.step4_title": "PASO 4: PEDALES - LÍMITES DE ACELERADOR, FRENO Y EMBRAGUE",
        "calib.step4_instructions": "1. Suelte todos los pedales por completo -> Haga clic en 'Guardar Límites de Reposo'.\n2. Pise el Acelerador a fondo -> 'Guardar Acelerador Máx'.\n3. Pise el Freno a fondo -> 'Guardar Freno Máx'.\n4. Pise el Embrague a fondo -> 'Guardar Embrague Máx'.\nO active 'Autodetección de Recorrido' y accione los pedales a fondo.",
        ...
        "calib.btn_save_clutch_max": "Guardar Embrague Máx",
        ...
        "calib.feedback_rest_saved": "Límites de Reposo -> Acelerador: {accel} | Freno: {brake} | Embrague: {clutch}",
        "calib.feedback_throttle_saved": "Límite Máximo de Acelerador: {val}",
        "calib.feedback_brake_saved": "Límite Máximo de Freno: {val}",
        "calib.feedback_clutch_saved": "Límite Máximo de Embrague: {val}",
        "calib.feedback_pump_pedals": "Accione todos los pedales a fondo para registrar el rango de recorrido.",
        "calib.feedback_envelope_captured": "Rango capturado -> Acelerador: [{a_min}..{a_max}], Freno: [{b_min}..{b_max}], Embrague: [{c_min}..{c_max}]",
        "calib.feedback_tracking": "[SEGUIMIENTO] Acel: {a_min}..{a_max} | Freno: {b_min}..{b_max} | Embrague: {c_min}..{c_max}",
        ...
        "calib.summary_clutch_pedal": "PEDAL DE EMBRAGUE:",
        ...
        "calib.summary_invert_clutch": "Invertir Embrague:",
        "calib.error_clutch_span": "Recorrido de embrague insuficiente (mín 20 cuentas)",
    ...
    "en": {
        ...
        "mapping.invert_clutch": "Invert Clutch Axis",
        ...
        "mapping.assigned_buttons": "Xbox Buttons",
        ...
        "calib.axis_clutch": "Clutch Pedal",
        ...
        "calib.step4_title": "STEP 4: PEDALS - THROTTLE, BRAKE & CLUTCH LIMITS",
        "calib.step4_instructions": "1. Release all pedals completely -> Click 'Save Rest Limits'.\n2. Press Throttle fully -> 'Save Throttle Max'.\n3. Press Brake fully -> 'Save Brake Max'.\n4. Press Clutch fully -> 'Save Clutch Max'.\nOr toggle 'Auto-Detect Travel' and pump all pedals through full stroke.",
        ...
        "calib.btn_save_clutch_max": "Save Clutch Max",
        ...
        "calib.feedback_rest_saved": "Rest Limits -> Throttle: {accel} | Brake: {brake} | Clutch: {clutch}",
        "calib.feedback_throttle_saved": "Throttle Max Limit: {val}",
        "calib.feedback_brake_saved": "Brake Max Limit: {val}",
        "calib.feedback_clutch_saved": "Clutch Max Limit: {val}",
        "calib.feedback_pump_pedals": "Pump all pedals fully to register travel envelope.",
        "calib.feedback_envelope_captured": "Envelope captured -> Throttle: [{a_min}..{a_max}], Brake: [{b_min}..{b_max}], Clutch: [{c_min}..{c_max}]",
        "calib.feedback_tracking": "[TRACKING] Accel: {a_min}..{a_max} | Brake: {b_min}..{b_max} | Clutch: {c_min}..{c_max}",
        ...
        "calib.summary_clutch_pedal": "CLUTCH PEDAL:",
        ...
        "calib.summary_invert_clutch": "Invert Clutch:",
        ...
        "calib.error_clutch_span": "Clutch travel too narrow (min 20 counts)",
